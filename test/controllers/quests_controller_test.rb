...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { mission_id: @quest.mission_id, name: @quest.name, world_id: @quest.world_id }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { mission_id: @quest.mission_id, name: @quest.name, world_id: @quest.world_id }
    assert_redirected_to quest_path(assigns(:quest))
  end
