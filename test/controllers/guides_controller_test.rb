...
class GuidesControllerTest < ActionController::TestCase
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post :create, guide: { approved: @guide.approved, body: @guide.body, subject: @guide.subject, user_id: @guide.user_id }
    end
  ...
  test "should update guide" do
    patch :update, id: @guide, guide: { approved: @guide.approved, body: @guide.body, subject: @guide.subject, user_id: @guide.user_id }
    assert_redirected_to guide_path(assigns(:guide))
  end
